...
resource "null_resource" "ansible-logs7" {
...
# Commenting out only for dev purposes
resource "null_resource" "ansible-delete-sensitive-data" {

    depends_on	= [ null_resource.ansible-logs7 ]
...
resource "null_resource" "ansible-errors" {
    ...
    depends_on	= [ null_resource.ansible-delete-sensitive-data ] # Commenting out only for dev purposes
    # depends_on	= [ null_resource.ansible-logs7 ]               # Commenting out only for dev purposes
