# Automation script for SAP Netweaver on Sybase ASE additional application server installation using Terraform and Ansible integration


## Description
This solution will perform automated deployment of **SAP Netweaver on ASE DB additional application server** on an existing system.
