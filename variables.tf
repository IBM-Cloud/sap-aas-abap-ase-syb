...
variable "REGION" {
	type		= string
	description	= "The cloud region where to deploy the solution. Must be the same as for the primary application server (SAP CI HOST). The available regions and zones for VPC can be found here: https://cloud.ibm.com/docs/containers?topic=containers-regions-and-zones#zones-vpc. Supported locations for IBM Cloud Schematics here: https://cloud.ibm.com/docs/schematics?topic=schematics-locations."
	validation {
...
variable "VPC" {
	type		= string
	description = "The name of an EXISTING VPC where to deploy the solution. Must be the same as for the primary application server (SAP CI HOST). The list of VPCs is available here: https://cloud.ibm.com/vpc-ext/network/vpcs."
	validation {
...
variable "SECURITY_GROUP" {
	type		= string
	description = "The name of an EXISTING Security group. Must be the same as for the primary application server (SAP CI HOST). The list of Security Groups is available here: https://cloud.ibm.com/vpc-ext/network/securityGroups."
	validation {
...
variable "SAP_CI_HOST" {
	type		= string
	description = "The IP address of the existing SAP Central Instance VSI"
}

variable "SAP_CI_HOSTNAME" {
	type		= string
	description = "The hostname of the existing SAP Central Instance VSI"
}
